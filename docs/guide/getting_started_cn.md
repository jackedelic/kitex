...
2. 安装 kitex：`go get github.com/jackedelic/kitex/tool/cmd/kitex@latest`
...
1. 你可以直接点击 [此处](https://github.com/jackedelic/kitex-examples/archive/refs/heads/main.zip) 下载示例仓库
2. 也可以克隆该示例仓库到本地 `git clone https://github.com/jackedelic/kitex-examples.git`
