...
- `Diff`:  it is used to compare  the discovery results with the last time. The differences in results are used to notify other components, such as [loadbalancer](https://github.com/jackedelic/kitex/blob/develop/docs/guide/extension/loadbalance.md) and circuitbreaker, etc
