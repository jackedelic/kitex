...
2. Install kitex: `go get github.com/jackedelic/kitex/tool/cmd/kitex@latest`
...
1. You can just click [HERE](https://github.com/jackedelic/kitex-examples/archive/refs/heads/main.zip) to download the example
2. Or you can clone the example repository `git clone https://github.com/jackedelic/kitex-examples.git`
...
`$ go get github.com/jackedelic/kitex/tool/cmd/kitex`
...
```
$ go get github.com/jackedelic/kitex
$ go mod tidy
```
